...
- Is it the most efficient form of version control and collaboration? (final_final-reallyfinal2.2.docx)
...
## Advantages
  ...
  - **Access**: several free alternatives
  - **Ownership**: not fixed to a single editor / programe
  - **Reproducibility**: allows combination of text and data analysis code in dynamic documents (no copy-paste)
  - **Collaboration**: better version control (who did what when) via Git-Github
