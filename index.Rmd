...
<input id="collapsible0" class="toggle" type="checkbox"><label for="collapsible1" class="lbl-toggle">
**Meritocracia y redistribución en una sociedad desigual** [(*link to presentation*)](https://juancarloscastillo.github.io/jc-castillo/documents/coes2018/castillo2018meritocracyCOES.html#1)
</label>
...
<div class="wrap-collabsible">
<input id="collapsible2" class="toggle" type="checkbox"><label for="collapsible1" class="lbl-toggle">
...
<div class="wrap-collabsible">
<input id="collapsible3" class="toggle" type="checkbox"><label for="collapsible2" class="lbl-toggle">
...
<div class="wrap-collabsible">
<input id="collapsible4" class="toggle" type="checkbox"><label for="collapsible3" class="lbl-toggle">**Poverty and wealth attributions: A second order confirmatory factor analysis model** <i class="ai ai-open-access fa-lg" style="font-size:20px"></i>
