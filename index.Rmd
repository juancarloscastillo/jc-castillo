...
**Desigualdad Económica, Percepción de Meritocracia y Preferencias Redistributivas** [(*link to presentation*)](https://juancarloscastillo.github.io/jc-castillo/documents/presentacion-final/present-panel-alas2018.html#1)
...
<div class="wrap-collabsible">
<input id="collapsible4" class="toggle" type="checkbox"><label for="collapsible4" class="lbl-toggle">**Poverty and wealth attributions: A second order confirmatory factor analysis model** <i class="ai ai-open-access fa-lg" style="font-size:20px"></i>
